...
if ~exist('./../Result/example-1','dir')
    mkdir ./../Result/example-1
end
...
for idx = 1:size(im,2)
    ...
    if idx == 1
        imwrite(A,map,['./../Result/example-1/conf.gif'],'gif','LoopCount',Inf,'DelayTime',0.01);
    else
        imwrite(A,map,['./../Result/example-1/conf.gif'],'gif','WriteMode','append','DelayTime',0.01);
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%