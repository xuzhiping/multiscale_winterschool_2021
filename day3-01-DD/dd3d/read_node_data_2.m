...
%
% Purpose:  Write ParaDis input files into DDLAB format
%
% How to use: 
%    1. Copy ParaDis file (.data and .cn) to current directory.
%    2. Just change the 'datafile' and 'cnfile'.
% 
% Note: 
%    1. Currently, this file can read the fixed format
%
% July 17 12:35am, 2007 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


datafile = 'restart75.data';
cnfile = 'restart.cn';

% 1. Generate 'rn matrix' from data file%%%%%%%%%%%%%%%%%%%%%
...
% 2.3 Reduce the links matrix
% In ParaDis, each nodal position is set twice, but in DDLAB, it
% is set once. Thus, half of nodal positions has to be reduced.
